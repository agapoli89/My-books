...
const Form = ({
    ...
    const handleAddBookForm = () => setAddBookFormVisible(prev => !prev);
    ...
    return (  
        <form onSubmit={handleFormSubmit} className="form accordion" id="accordionExample">
            <div className="accordion-item">
                ...
                <div id="collapseOne" className={`accordion-collapse collapse ${addBookFormVisible || id ? 'show' : null}`}aria-labelledby="headingOne" data-bs-parent="#accordionExample">
